...
const { getDashboardpage, getCmspage, getAdminLoginpage, getAdminRegisterpage, handleRegisterAdmin, handleAdminlogin, postLogoutAdmin, getuserspage, getSingleUser,approveUser } = require("../controllers/admin.controller");
